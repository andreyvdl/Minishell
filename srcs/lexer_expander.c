...
char	*expand_it(char *str, t_hash *hash)
{
	char	*new_cmd;
	size_t	size;
...
size_t	size_with_values(char *str, t_hash *hash)
{
	size_t	counter;
...
void	single_quote_size(char **str, size_t *counter)
{
	(*str)++;
	(*counter)++;
	while (**str != '\'' && **str)
...
void	get_value_size_double(char **str, size_t *counter, t_hash *hash)
{
	(*str)++;
	(*counter)++;
	while (**str != '\"' && **str)
...
void	get_value_dollar_size(char **str, size_t *counter, t_hash *hash)
{
	char	*key;
